...
<tr height="30px"  bgcolor="#5D7B9D"><td  colspan="4" align="center"><font color="#ffffff"><b>성적 등록</b></td></tr> 
</table>
<br/><br/>

<table width="50%" style="border: 1px solid #d7d7d7">
	<tr height="30px">
		<td bgcolor="#efefef" width="10%" align="center"><b> 이름 </b></td>
		<td width="30%" align="left"><b> &nbsp <asp:TextBox ID="txtTitle" runat="server"></asp:TextBox></b></td> 
	</tr>
</table>
<br/><br/> 
...
<table width="50%" border="1" bordercolor="#d7d7d7">
	<tr height="100px">
		...
		<td width="30%" align="left"><b><asp:TextBox ID="txtContent" runat="server" TextMode="MultiLine" width="98%" Rows="6"></asp:TextBox></b></td>
	</tr>
</table> 
<br/><br/>
...
<table width="50%" style="border: 1px solid #d7d7d7">
	<tr height="30px">
		...
		<td width="30%" align="left"><b><asp:TextBox ID="txtts" runat="server"></asp:TextBox> </b></td> 
	</tr>
</table>
